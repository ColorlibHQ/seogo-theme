...
function seogo_widgets_init() {
    // sidebar widgets register
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar', 'seogo' ),
        'id'            => 'seogo-post-sidebar',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Two', 'seogo' ),
        'id'            => 'footer-2',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Three', 'seogo' ),
        'id'            => 'footer-3',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Four', 'seogo' ),
        'id'            => 'footer-4',
        'before_widget' => '<div class="col-xl-4 offset-xl-1 col-md-6 col-lg-4"><div id="%1$s" class="single-footer-widget menu_links footer_widget widget footer_4 %2$s">',
        'after_widget'  => '</div></div>',
        'before_title'  => '<h3 class="footer_title">',
        'after_title'   => '</h3>',
    ) );
...
add_action( 'widgets_init', 'seogo_widgets_init' );

...
// image default alt
if ( ! function_exists( 'seogo_img_default_alt' ) ) {
	function seogo_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'seogo_img_tag' ) ) {
	function seogo_img_tag( array $args ) {
...
// Anchor Tag
if ( ! function_exists( 'seogo_anchor_tag' ) ) {
	function seogo_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'seogo_heading_tag' ) ) {
	function seogo_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'seogo_paragraph_tag' ) ) {
	function seogo_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'seogo_other_tag' ) ) {
	function seogo_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'seogo_button_element ' ) ) {
	function seogo_button_element( array $args ) {

...
// enqueue css
function seogo_common_custom_css(){
    
    wp_enqueue_style( 'seogo-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= seogo_opt( 'seogo_theme_color' ) != '#131313' ? seogo_opt( 'seogo_theme_color' ) : '';
		$themeSecColor     		  	= '';
		$bookBtnColor       		= seogo_opt( 'seogo_book_btn_color' ) != '#131313' ? seogo_opt('seogo_book_btn_color') : '';
		$bookBtnHoverBgColor     	= seogo_opt( 'seogo_book_btn_hvr_bg_color' ) != '#131313' ? seogo_opt('seogo_book_btn_hvr_bg_color') : $themeColor;
		$hoverColor     	  	  = seogo_opt( 'seogo_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = seogo_opt( 'seogo_navbar_bg_color' ) != '#082b49' ? seogo_opt( 'seogo_navbar_bg_color') : '';
		$headerTop_col     		  = seogo_opt( 'seogo_top_header_color' );

		$headerTopBg      		  = seogo_opt( 'seogo_top_header_bg_color');
		$headerBg          		  = seogo_opt( 'seogo_header_bg_color') != '#ffffff' ? seogo_opt( 'seogo_header_bg_color') : '';
		$menuColor          	  = seogo_opt( 'seogo_header_menu_color' ) != '#131313' ? seogo_opt('seogo_header_menu_color') : '';
		$menuHoverColor           = seogo_opt( 'seogo_header_menu_hover_color' ) != '#808080' ? seogo_opt('seogo_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = seogo_opt( 'seogo_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = seogo_opt( 'seogo_header_drop_menu_bg_color' ) != '#ffffff' ? seogo_opt('seogo_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = seogo_opt( 'seogo_dropdown_menu_color' ) != '#131313' ? seogo_opt('seogo_dropdown_menu_color') : '';
		$dropMenuHovColor         = seogo_opt( 'seogo_dropdown_menu_hover_color' ) != '#808080' ? seogo_opt('seogo_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = seogo_opt( 'seogo_footer_widget_bg_color' );
		$footerwHeadColor   	  = seogo_opt('seogo_footer_widget_heading_color');
		$footerwTextColor   	  = seogo_opt('seogo_footer_widget_text_color');
		$footerwanchorcolor 	  = seogo_opt('seogo_footer_widget_anchor_color') != '#ffffff' ? seogo_opt('seogo_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = seogo_opt('seogo_footer_widget_anchor_hover_color') != '#ffffff' ? seogo_opt('seogo_footer_widget_anchor_hover_color') : '';
		
		$fofbg					  = seogo_opt('seogo_fof_bg_color');
		$foftonecolor			  = seogo_opt('seogo_fof_textone_color');
		$fofttwocolor			  = seogo_opt('seogo_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = seogo_opt('seogo_footer_widget_anchor_color') != '#9e9e9e' ? seogo_opt('seogo_footer_widget_anchor_color') : '';
		...
		$customcss ="			
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .seogo_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .seogo_mailchimp_newsletter_widget button
			{
    ...
    wp_add_inline_style( 'seogo-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'seogo_common_custom_css', 50 );
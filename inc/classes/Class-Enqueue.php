 ...
 */
	...
	class seogo_Enqueue{
		...
		public function seogo_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'seogo_frontend_enqueue_scripts', ) );
		}

		public function seogo_frontend_enqueue_scripts( ){
